...
class ScoutingScreen(ctk.CTkFrame):
    ...
    def _build_assign_section(self):
        ...
        # Inner padding frame.
        inner = ctk.CTkFrame(form_card, fg_color="transparent", border_width=0)
        inner.pack(fill="x", padx=15, pady=15)

        # Row 1: Scout dropdown.
        scout_row = ctk.CTkFrame(inner, fg_color="transparent", border_width=0)
        ...
        target_row = ctk.CTkFrame(inner, fg_color="transparent", border_width=0)
        ...
        button_row = ctk.CTkFrame(inner, fg_color="transparent", border_width=0)
    ...
    def _build_report_card(self, parent, report):
        ...
        # Inner padding frame.
        inner = ctk.CTkFrame(card, fg_color="transparent", border_width=0)
        ...
        for label_text, value_text in fields:
            field_row = ctk.CTkFrame(inner, fg_color="transparent", border_width=0)
