...
class FighterProfileScreen(ctk.CTkFrame):
    ...
    def _build_back_button(self):
        ...
        """
        theme = get_theme()
        back_row = ctk.CTkFrame(self, fg_color="transparent", border_width=0)
    ...
    def _build_header(self):
        ...
        header_row = ctk.CTkFrame(self._scroll, fg_color="transparent", border_width=0)
        ...
        # ---- RIGHT: Name + Subtitle ----
        name_subtle_container = ctk.CTkFrame(header_row, fg_color="transparent", border_width=0)
    ...
    def _build_identity_block(self):
        ...
        identity_main = ctk.CTkFrame(card, fg_color="transparent", border_width=0)
        ...
        self._identity_content = ctk.CTkFrame(identity_main, fg_color="transparent", border_width=0)
    ...
    def _build_bio_section(self):
        ...
        self._bio_content = ctk.CTkFrame(card, fg_color="transparent", border_width=0)
    ...
    def _build_career_section(self):
        ...
        self._career_content = ctk.CTkFrame(card, fg_color="transparent", border_width=0)
    ...
    def _build_recent_fights(self):
        ...
        self._fights_content = ctk.CTkFrame(card, fg_color="transparent", border_width=0)
    ...
    def _build_attribute_profile(self):
        ...
        title_row = ctk.CTkFrame(self._attr_card, fg_color="transparent", border_width=0)
        ...
        self._attr_content = ctk.CTkFrame(self._attr_card, fg_color="transparent", border_width=0)
    ...
    def _build_personality(self):
        ...
        self._pers_content = ctk.CTkFrame(self._pers_card, fg_color="transparent", border_width=0)
    ...
    def _refresh_recent_fights(self, conn, data):
        ...
        try:
            ...
            for (event_date, outcome, result_type, finish_round,
                ...
                inner = ctk.CTkFrame(row_card, fg_color="transparent", border_width=0)
    ...
    def _render_descriptor_grid(self, parent, widget_list, keys, descriptors,
        ...
        for i, key in enumerate(keys):
            ...
            cell = ctk.CTkFrame(parent, fg_color="transparent", border_width=0)
