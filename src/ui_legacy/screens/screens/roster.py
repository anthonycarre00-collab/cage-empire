...
class RosterScreen(ctk.CTkFrame):
    ...
    def _build_header(self):
        ...
        header_row = ctk.CTkFrame(self, fg_color="transparent", border_width=0)
        ...
        title_subtitle_stack = ctk.CTkFrame(header_row, fg_color="transparent", border_width=0)
    ...
    def _build_filter_row(self):
        ...
        filter_row = ctk.CTkFrame(self, fg_color="transparent", border_width=0)
    ...
    def _build_table_new(self):
        ...
        # card's tier (was bg_surface — same as the shell, which made
        # the table read as a hole in the page rather than a card).
    ...
    def _build_pagination(self):
        ...
        pagination_row = ctk.CTkFrame(self, fg_color="transparent", border_width=0)
